#!/bin/bash
############################################
# PSC / Bridges-2 sbatch headers
############################################

#!/bin/bash


#SBATCH --job-name=neuro
#SBATCH -A cis250217p                 
#SBATCH -p GPU-shared                 
...
mkdir -p /ocean/projects/cis250217p/ylei5/Neuroprobe/data/logs
source /ocean/projects/cis250217p/shared/envs/miniconda3/bin/activate
conda activate /ocean/projects/cis250217p/shared/envs/miniconda3/envs/yu_env
...
declare -a eval_names=(
  "frame_brightness" "global_flow" "local_flow" "face_num"
...
# Launch
############################################
python -u /ocean/projects/cis250217p/ylei5/Neuroprobe/examples/eval_population.py \
  --eval_name "$EVAL_NAME" \
  --subject_id "$SUBJECT" \
  --trial_id "$TRIAL" \
